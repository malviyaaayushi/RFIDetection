...
net = Network([ConvPoolLayer(image_shape=(mini_batch_size, 1, size_x, size_y), filter_shape=(20, 1, 5, 5), poolsize=(2, 2)), FullyConnectedLayer(n_in=20*12*12, n_out=100), SoftmaxLayer(n_in=100, n_out=num_possible_outcomes)], mini_batch_size)
